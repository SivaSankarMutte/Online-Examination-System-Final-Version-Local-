 ...
 * @author SIVASANKAR
 */
public class sendOTPToSuperAdminServlet extends HttpServlet {
    ...
    {  
        ...
        try
        {
            ...
            response.sendRedirect("superAdminResetPassword.jsp");
        }
        catch(Exception e)
        {
            response.sendRedirect("OTPFailedToSendSuperAdmin.jsp");
        }
    }
}
