...
<body id="page-top">
    <% 
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <sql:query dataSource="${db}" var="g">
                select * from ${sessionScope.resultsTableName} where totalMarks!='A' order by regdNo;
            </sql:query>
            <sql:query dataSource="${db}" var="c">
                select count(*) studentsCount from ${sessionScope.resultsTableName} where totalMarks!='A';
            </sql:query>
                <c:forEach var="row1" items="${c.rows}">
                    <div class="jumbotron my-5">
                    <div class="chart-area">
                        <canvas data-bss-chart="{&quot;type&quot;:&quot;line&quot;,&quot;data&quot;:{&quot;labels&quot;:[<c:forEach var="row" items="${g.rows}" varStatus="loop"><c:choose><c:when test="${row1.studentsCount!=loop.count}">&quot;${row.regdNo}&quot;,</c:when><c:otherwise>&quot;${row.regdNo}&quot;</c:otherwise></c:choose></c:forEach>],&quot;datasets&quot;:[{&quot;label&quot;:&quot;Marks&quot;,&quot;fill&quot;:true,&quot;data&quot;:[<c:forEach var="row" items="${g.rows}" varStatus="loop"><c:choose><c:when test="${row1.studentsCount!=loop.count}">&quot;${row.totalMarks}&quot;,</c:when><c:otherwise>&quot;${row.totalMarks}&quot;</c:otherwise></c:choose></c:forEach>],&quot;backgroundColor&quot;:&quot;rgba(78, 115, 223, 0.05)&quot;,&quot;borderColor&quot;:&quot;rgba(78, 115, 223, 1)&quot;}]},&quot;options&quot;:{&quot;maintainAspectRatio&quot;:false,&quot;legend&quot;:{&quot;display&quot;:false,&quot;labels&quot;:{&quot;fontStyle&quot;:&quot;normal&quot;}},&quot;title&quot;:{&quot;fontStyle&quot;:&quot;normal&quot;},&quot;scales&quot;:{&quot;xAxes&quot;:[{&quot;gridLines&quot;:{&quot;color&quot;:&quot;rgb(234, 236, 244)&quot;,&quot;zeroLineColor&quot;:&quot;rgb(234, 236, 244)&quot;,&quot;drawBorder&quot;:false,&quot;drawTicks&quot;:false,&quot;borderDash&quot;:[&quot;2&quot;],&quot;zeroLineBorderDash&quot;:[&quot;2&quot;],&quot;drawOnChartArea&quot;:false},&quot;ticks&quot;:{&quot;fontColor&quot;:&quot;#858796&quot;,&quot;fontStyle&quot;:&quot;normal&quot;,&quot;padding&quot;:20}}],&quot;yAxes&quot;:[{&quot;gridLines&quot;:{&quot;color&quot;:&quot;rgb(234, 236, 244)&quot;,&quot;zeroLineColor&quot;:&quot;rgb(234, 236, 244)&quot;,&quot;drawBorder&quot;:false,&quot;drawTicks&quot;:false,&quot;borderDash&quot;:[&quot;2&quot;],&quot;zeroLineBorderDash&quot;:[&quot;2&quot;]},&quot;ticks&quot;:{&quot;fontColor&quot;:&quot;#858796&quot;,&quot;fontStyle&quot;:&quot;normal&quot;,&quot;padding&quot;:20}}]}}}"></canvas>
                    </div>
                    </div>
                </c:forEach>   
