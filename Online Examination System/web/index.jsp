...
<head>
    ...
    <title>Dashboard - BEC</title>
    <meta name="description" content="BEC Exam Portal">
    <link rel="stylesheet" href="assets\bootstrap\css\bootstrap.min.css?h=f7674e9e3f475c298048d734e2d1adff">
    ...
    <link rel="stylesheet" href="assets\css\styles.min.css?h=8c38771972525e111a6e229baa1f0b51">
            ...
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <% 
                        ...
                        { %>
                            <li class="nav-item"><a class="nav-link" href="facultyHome.jsp"><i class="icon ion-ios-home"></i>&nbsp;Home</a></li>
                    <%  }
                    %>
...
<!--                    <li class="nav-item"><a class="nav-link" href="/register.html"><i class="fas fa-user-circle"></i><span>Register</span></a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="/graphs.html"><i class="icon ion-pie-graph"></i>&nbsp;Graphs</a></li>-->
                </ul>
                    ...
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        ...
                        <ul class="navbar-nav flex-nowrap ms-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small">Faculty Login</span><img class="border rounded-circle img-profile" src="assets\img\195-1957039_bapatla-engineering-college-logo-hd-png-download-removebg-preview.png"></a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-7 col-xl-8">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center" style="background: var(--bs-success);">
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-4">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3" style="background: var(--bs-success);">
    ...
    <script src="assets\js\script.min.js?h=b122fb9afd3c87b8dfdbf4f3ce094a83"></script>
</body>
