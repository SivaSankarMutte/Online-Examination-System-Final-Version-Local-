<%-- 
    Document   : deleteExamYesNo
    Created on : 7 Feb, 2022, 8:16:12 PM
    Author     : SIVASANKAR
--%>
...
<head>
    ...
    <title>Exam Deletion Confirmation</title>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content" style="background: #ffffff;height: 575px;">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">Exam Deletion Confirmation</h3>
                </div>
                <div class="container mt-5 rounded">
                   <div class="card">
                            <h1>Do you want to delete Exam</h1>
                            <div class="row">
                                <div class="col">
                                ...
                                <div class="col">
                                    <a href="addQuestionForm.jsp" class="btn btn-primary form-control">No</a>
                                </div>            
                            </div> 
                            <br/>
                        </div>
