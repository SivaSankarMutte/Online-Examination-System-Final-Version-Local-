<%-- 
    ...
    Created on : 22 Feb, 2022, 4:14:44 PM
    Author     : SIVASANKAR
--%>
        ...
        <div class="card">
                    <div class="card shadow mb-3">
                        <div class="card-header py-3" style="background: var(--bs-success); height: 100px;">
                            <p class="text-primary m-0 fw-bold">Admin Reset Password</p>
                        </div>
                        <div class="card-body">
                        <form action="saveAdminPassword.jsp" method="post" class="form-control">
                             <div class="row">
                                    <div class="col">
