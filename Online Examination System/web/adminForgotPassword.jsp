<%-- 
    ...
    Created on : 22 Feb, 2022, 4:06:44 PM
    Author     : SIVASANKAR
--%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="sendOTPToAdminServlet" method="post">
...
<!--                                    <div class="text-center">
                                    ...
                                    <div class="text-center"><a class="small" href="adminLogin.jsp">Already have an account? Login!</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
