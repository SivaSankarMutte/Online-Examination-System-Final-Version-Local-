<%-- 
    Document   : sendMailToStudentsYesOrNo
    Created on : 5 Apr, 2022, 1:15:23 PM
    Author     : SIVASANKAR
--%>
...
<head>
    ...
    <title>Mails Sending Confirmation</title>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content" style="background: #ffffff;height: 575px;">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">Do you want to Send Mails to Students?</h3>
                </div>
                <div class="container mt-5 rounded">
                   <div class="card">
                            <h1>Do you want Send Mails</h1>
                            <div class="row">
                                <div class="col">
                                    <form method="post" action="sendMailToStudent">
                                        <input type="submit" class="btn btn-primary form-control" value="Yes">
                                    </form>
                                </div>
                                <div class="col">
                                    <a href="addQuestionForm.jsp" class="btn btn-danger form-control">No</a>
                                </div>            
                            </div> 
                            <br/>
                        </div>
