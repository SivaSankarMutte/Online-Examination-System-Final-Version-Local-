<%-- 
    Document   : updateQuestionAlongWithImages
    Created on : 6 Apr, 2022, 12:27:24 AM
    Author     : SIVASANKAR
--%>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content" style="background: #ffffff;height: 575px;">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">Updating a Question</h3>
                </div>
                <div class="container mt-5">
                <div class="card">
                    <form action="updateQuestionServlet" method="post" enctype="multipart/form-data" class="form-control">
            <fieldset>
                ...
                <c:forEach items="${rs.rows}" var="row">
                    ...
                    <input type="text" name="formQuestionName" id="formQuestionName" placeholder="Enter Question" class="form-control my-2" value="${row.questionName}">
                    <br/>
                        ...
                        <center>
                            <c:choose>
                                <c:when test="${empty row.questionNameImg}">
                                    <img id="questionImageDisplay" height="200px" width="100%"/>
                                </c:when>
                                <c:otherwise>
                                    <img src="${row.questionNameImg}" id="questionImageDisplay" alt="Image Loading" height="200px" width="100%">
                                </c:otherwise>
                            </c:choose>
                        </center><br/><br/>
                    ...
                    <input type="text" name="formOpt1" id="formOpt1" placeholder="Enter Option1" class="form-control my-2" value="${row.opt1}">
                    <input type="file" name="formOpt1Img" onchange="loadFile1(event)" class="form-control">
                        <center>
                            <c:choose>
                                <c:when test="${empty row.opt1Img}">
                                    <img id="option1ImageDisplay" height="200px" width="100%"/>
                                </c:when>
                                <c:otherwise>
                                    <img src="${row.opt1Img}" id="option1ImageDisplay" alt="Image Loading" height="200px" width="100%">
                                </c:otherwise>
                            </c:choose>
                        </center><br/><br/>
                    <br/>
                    <label for="formOpt2">Enter Option2</label>
                    <input type="text" name="formOpt2" id="formOpt2" placeholder="Enter Option2" class="form-control my-2" value="${row.opt2}">
                    <input type="file" name="formOpt2Img" onchange="loadFile2(event)" class="form-control">
                        <center>
                            <c:choose>
                                <c:when test="${empty row.opt2Img}">
                                    <img id="option2ImageDisplay" height="200px" width="100%"/>
                                </c:when>
                                <c:otherwise>
                                    <img src="${row.opt2Img}" id="option2ImageDisplay" alt="Image Loading" height="200px" width="100%">
                                </c:otherwise>
                            </c:choose>
                        </center><br/><br/>
                    <br/>
                    ...
                    <input type="file" name="formOpt3Img" onchange="loadFile3(event)" class="form-control">
                        <center>
                            <c:choose>
                                <c:when test="${empty row.opt3Img}">
                                    <img id="option3ImageDisplay" height="200px" width="100%"/>
                                </c:when>
                                <c:otherwise>
                                    <img src="${row.opt3Img}" id="option3ImageDisplay" alt="Image Loading" height="200px" width="100%">
                                </c:otherwise>
                            </c:choose>
                        </center><br/><br/>
                    <br/>
                    ...
                    <input type="file" name="formOpt4Img" onchange="loadFile4(event)" class="form-control">
                        <center>
                            <c:choose>
                                <c:when test="${empty row.opt4Img}">
                                    <img id="option4ImageDisplay" height="200px" width="100%"/>
                                </c:when>
                                <c:otherwise>
                                    <img src="${row.opt4Img}" id="option4ImageDisplay" alt="Image Loading" height="200px" width="100%">
                                </c:otherwise>
                            </c:choose>
                        </center><br/><br/>
                    <br/>
                ...
                <div class="row">
                    <div class="col">
                        <a href="questions.jsp" class="btn btn-info form-control my-2">Back</a>
                    </div>
                    <div class="col">
