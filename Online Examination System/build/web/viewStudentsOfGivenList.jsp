<%-- 
    Document   : viewStudentsOfGivenList
    Created on : 26 Jan, 2022, 3:20:27 PM
    Author     : SIVASANKAR
--%>
...
<body id="page-top">
    ...
    %>
        ...
        <sql:query dataSource="${db}" var="result">
            select * from ${sessionScope.studentsTableName} where listName=? order by regdNo;
            <sql:param value="${sessionScope.listName}"/>
        </sql:query>
            <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content" style="background: #ffffff;height: 575px;">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Students (${sessionScope.listName})</h3>
                                    ...
                                    <tbody>
                                        <c:forEach var="row" items="${result.rows}" varStatus="loop">
                                            <tr>
                                                ...
                                                <td>
                                                    <form method="post" action="updateStudentOfGivenList.jsp">
                                                        <input type="hidden" name="studentId" value="${row.studentId}"/>
                                                        <input type="submit" class="btn btn-outline-warning" value="UPDATE">
                                                    </form>
                                                </td>
                                                <td>
                                                    <form method="post" action="deleteStudentYesNoOfGivenList.jsp">
                                                        <input type="hidden" name="studentId" value="${row.studentId}"/>
