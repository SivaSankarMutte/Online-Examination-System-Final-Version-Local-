<%-- 
    Document   : updateFacultyProfile
    Created on : 10 Feb, 2022, 6:42:24 PM
    Author     : SIVASANKAR
--%>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content" style="background: #ffffff;height: 575px;">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">Faculty Profile</h3>
                </div>
                ...
                <div class="card">
                    <div class="card shadow mb-3">
                        <div class="card-header py-3" style="background: var(--bs-success); height: 100px;">
                            <p class="text-primary m-0 fw-bold">Faculty Settings</p>
                        </div>
                        <div class="card-body">
                        <form action="updateFacultyProfileToDB.jsp" method="post" class="form-control">
                            <sql:setDataSource var="db" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:3306/demo2?useSSL=false&allowPublicKeyRetrieval=true" user="siva" password="0000"/>
                            ...
                            <c:forEach items="${rs.rows}" var="row">
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label" for="username"><strong>Username</strong></label><input class="form-control" type="text" id="username" placeholder="user.name" name="formFacultyName" value="${row.facultyName}"></div>
                                    </div>
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label" for="email"><strong>Email Address</strong></label><input class="form-control" type="email" id="email" placeholder="user@example.com" name="formFacultyEmail" value="${row.email}"></div>
                                    </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
