<%-- 
    Document   : deleteStudentYesNoOfGivenList
    Created on : 5 Apr, 2022, 3:14:50 PM
    Author     : SIVASANKAR
--%>
...
<head>
    ...
    <title>Deleting Student details</title>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content" style="background: #ffffff;height: 575px;">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">Deleting Student Details</h3>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="row">
                        <div class="col">
                                <form method="post" action="deleteStudentOfGivenList.jsp">
                        ...
                        <div class="col">
                            <a href="viewStudentsOfGivenList.jsp" class="btn btn-outline-success form-control my-2">No</a>
                        </div>            
                    </div>  
                </div>
            </div>
