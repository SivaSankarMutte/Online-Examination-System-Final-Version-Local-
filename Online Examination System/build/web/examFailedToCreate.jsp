<%-- 
    Document   : examFailedToCreate
    Created on : 2 Dec, 2021, 8:55:19 PM
    Author     : SIVASANKAR
--%>
...
<head>
    ...
    <title>Exam failed to create</title>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content" style="background: #ffffff;height: 575px;">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">Exam Creation Failed</h3>
                </div>
                <div class="container mt-5">
            
            
                <div class="card">
                    <h1>Exam Creation Failed</h1>
                </div>
            </div>
