<%-- 
    Document   : updateStudentOfGivenList
    Created on : 5 Apr, 2022, 3:13:46 PM
    Author     : SIVASANKAR
--%>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content" style="background: #ffffff;height: 575px;">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">Updating Student Deatils</h3>
                </div>
                <div class="container mt-5">
            
            
                <div class="card">
                    <form action="updateStudentToDBOfGivenList.jsp" method="post" class="form-control">
                        <fieldset>
                        ...
                        <div class="row">
                            <div class="col">
                                <a href="viewStudentsOfGivenList.jsp" class="btn btn-info form-control my-2">Back</a>
                            </div>
                            <div class="col">
